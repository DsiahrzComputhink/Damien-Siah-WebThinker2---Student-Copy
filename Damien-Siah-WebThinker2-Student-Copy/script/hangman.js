    ...
    if(guess.kindexOf(key) == -1){
        ...
        if(word.indexOf(key) !=-1){
            ...
            for(let i = 0;i<word.length;i++){
                ...
                }else if(guess.indexOf(world[i])!=-1){
